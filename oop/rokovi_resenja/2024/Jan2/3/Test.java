...
public class Test2 {
    public static void main(String[] args) {
        ...
        MatematickiSkup2<Osoba> s1 = new MatematickiSkup2<>("skup1", 2);
        MatematickiSkup2<Osoba> s2 = new MatematickiSkup2<>("skup2", 3);
        ...
        MatematickiSkup2<Osoba> unijas1s2 = s1.unija(s2);
        ...
        if (maksimum.isPresent()) {
            System.out.println("Leksikografski max osoba u skupu s2 je = " + maksimum.get());
        }
        else  {
            System.out.println("Skup s1 je prazan!");
        }
